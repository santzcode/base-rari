...
`,
  jc = me.button` 
    ...
    color: ${(e) =>
      e.city ? "rgba(34, 232, 235, 1)" : "rgba(246, 59, 59, 1)"};
...
`,
  ...
  aS = me.button` 
    ...
    background: ${(e) =>
      e.city ? "rgba(34, 232, 235, 0.2)" : "rgba(246, 59, 59, 0.2)"};
    ...
    svg {
        ...
        stroke: ${(e) =>
          e.city ? "rgba(34, 232, 235, 0.6)" : "rgba(246, 59, 59, 0.6)"};
    }

    :hover {
        background: ${(e) =>
          e.city ? "rgba(34, 232, 235, 0.4)" : "rgba(246, 59, 59, 0.4)"};
...
const wS = "http://189.127.165.188/vehicles/";
