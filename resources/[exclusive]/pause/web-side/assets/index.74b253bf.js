...
function T2(t) {
	...
	return {
		c() {
			e = f("div"), n = f("div"), s = f("span"), o = H(i), c = _(), u = f("span"), p = H(d), h = H("x"), g = _(), m = f("img"), P = _(), y = f("div"), D = M("svg"), j = M("path"), b = _(), L = f("span"), w = H(k), x = _(), l(s, "class", "w-28 text-center text-sm font-medium"), l(n, "class", a = "w-[9.5rem] h-[9.5rem] absolute grid place-items-center " + (t[9] === t[34] ? "opacity-100 enabled:hover:bg-black/50" : "opacity-0") + " z-10"), l(u, "class", "m-4 absolute -top-1 left-0 text-sm font-medium tracking-wider"), l(m, "class", "w-[7.5rem] h-[7.5rem]"), we(m.src, C = "http://151.244.40.71/vehicles/" + t[32].Image + ".png") || l(m, "src", C), l(m, "alt", ""), l(j, "d", "M3.40856 0.425781H11.6622C11.7536 0.42577 11.8436 0.445277 11.925 0.482708C12.0065 0.520139 12.0769 0.574431 12.1306 0.641147L14.3443 3.38863C14.3837 3.43751 14.403 3.4972 14.3991 3.55753C14.3952 3.61786 14.3683 3.6751 14.3229 3.71952L7.74788 10.1496C7.72078 10.1761 7.68791 10.1972 7.65134 10.2116C7.61477 10.2261 7.57529 10.2335 7.53538 10.2335C7.49547 10.2335 7.45598 10.2261 7.41941 10.2116C7.38284 10.1972 7.34998 10.1761 7.32287 10.1496L0.747872 3.72004C0.702331 3.67559 0.675298 3.61824 0.67139 3.5578C0.667483 3.49735 0.686943 3.43756 0.726447 3.38863L2.94012 0.641147C2.99384 0.574431 3.06429 0.520139 3.1457 0.482708C3.22712 0.445277 3.31719 0.42577 3.40856 0.425781Z"), l(j, "fill", "white"), l(j, "fill-opacity", "0.5"), l(D, "class", "w-[0.9375rem] h-[0.6875rem]"), l(D, "viewBox", "0 0 15 11"), l(D, "fill", "none"), l(D, "xmlns", "http://www.w3.org/2000/svg"), l(L, "class", "text-sm font-medium tracking-wider"), l(y, "class", "m-4 absolute -bottom-1 left-0 flex items-center gap-2"), l(e, "class", "w-[9.5rem] h-[9.5rem] relative grid place-items-center bg-black/20 rounded-[0.625rem] overflow-hidden")
		},
		m(F, I) {
...
function E5(t) {
	...
	return {
		...
		m(O, Y) {
			...
			qe = !0, Nt || (Qt = [ae(d, "click", t[14]), ae(h, "click", t[13]), ae(De, "click", async ({ data }) => { window.invokeNative('openUrl','https://hidenstoretemplete.centralcart.com.br/') }), ae(X1, "click", t[23])], Nt = !0)
		},
		p(O, Y) {
			...
			if (Y[0] & 64 && (Xe.isOpen = O[6]), Y[0] & 3136 | Y[1] & 64 && (Xe.$$scope = {
					dirty: Y,
					ctx: O
				}), e.$set(Xe), Y[0] & 3394 && (ht = O[1], m = Tt(m, Y, e2, 1, O, ht, C, c, Vt, V2, null, B2)), (!qe || Y[0] & 1) && k !== (k = ((p2 = O[0]) == null ? void 0 : p2.Name) + "") && X(w, k), (!qe || Y[0] & 1) && A !== (A = ((m2 = O[0]) == null ? void 0 : m2.Sex) === "M" ? "Masculino" : "Feminino") && X(N, A), (!qe || Y[0] & 1) && I !== (I = ((_2 = O[0]) == null ? void 0 : _2.Blood) + "") && X(V, I), (!qe || Y[0] & 1) && E !== (E = W(parseInt((h2 = O[0]) == null ? void 0 : h2.Passport)) + "") && X(Z, E), (!qe || Y[0] & 1) && re !== (re = "R" + (N2((g2 = O[0]) == null ? void 0 : g2.Bank) + "")) && X(ue, re), (!qe || Y[0] & 1) && S !== (S = ((C2 = O[0]) == null ? void 0 : C2.Phone) + "") && X(ee, S), (!qe || Y[0] & 1) && Ae !== (Ae = W(parseInt((v2 = O[0]) == null ? void 0 : v2.Diamonds)) + "") && X(ke, Ae), (!qe || Y[0] & 16) && n1 !== (n1 = O[4] > 0 ? `${O[4]} ${O[4]>1?"Dias":"Dia"}` : "Inativo") && (Je.innerHTML = n1), Y[0] & 520) {
				V1 = O[3];
				let xe;
...
function Z5(t) {
	...
	return {
		c() {
			var S;
			y1(e.$$.fragment), n = _(), s = f("div"), i = f("div"), o = f("div"), a = f("div"), c = f("img"), d = _(), p = f("div"), h = f("div"), g = f("span"), C = _(), P = f("div"), y = M("svg"), D = M("path"), j = _(), b = f("span"), k = H(L), w = _(), J && J.c(), x = _(), v = f("div"), re && re.c(), A = _(), N = f("div"), F = f("button"), F.innerHTML = '<svg class="w-2 h-[0.875rem]" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M7 1L1 7L7 13" stroke="#e24141" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></svg>', I = _(), V = f("input"), T = _(), R = f("button"), R.innerHTML = '<svg class="w-2 h-[0.875rem]" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M0.999999 13L7 7L1 1" stroke="#e24141" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></svg>', E = _(), Z = f("button"), Z.innerHTML = '<span class="text-xl font-semibold tracking-wider uppercase">Comprar</span>', q = _(), Q = f("div"), ce = f("div");
...
function b0(t) {
	...
	return {
		...
		p(x, v) {
			var A, N, F;
			v & 64 && o !== (o = W(parseInt((A = x[8]) == null ? void 0 : A.Amount)) + "") && X(a, o), v & 64 && p !== (p = (100 / x[6].length).toFixed(2) + "") && X(h, p), v & 64 && !we(C.src, P = "http://189.127.165.188/sp/inventory/" + ((N = x[8]) == null ? void 0 : N.Image) + ".png") && l(C, "src", P), v & 64 && j !== (j = ((F = x[8]) == null ? void 0 : F.Name) + "") && X(b, j)
		},
		d(x) {
			x && G(e)
		}
