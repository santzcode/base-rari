...
function Ys() {
	...
	return Xs = [Ks("settings", "/settings", "", t("settings.png"), !0), Ks("contacts", "/contacts", "", t("phone.png"), !0), Ks("sms", "/sms", "", t("sms.webp"), !0), Ks("gallery", "/gallery", "", t("photos.webp"), !0), Ks("whatsapp", "/whatsapp", "WhatsApp", t("whatsapp.jpg")), Ks("tor", "/tor", "TOR", t("tor.jpg")), Ks("instagram", "/instagram/login", "Instagram", t("instagram.jpg")), Ks("twitter", "/twitter", "Twitter", t("twitter.png")), Ks("bank", "/bank", Js[Ao.settings.bankType.replace(/\d/g, "")], t(Ao.settings.bankType.toLowerCase() + ".webp")), Ks("paypal", "/paypal", "PayPal", t("paypal.webp")), Ks("olx", "/olx", "OLX", t("olx.png"), !0), Ks("marketplace", "/marketplace", "Marketplace", t("marketplacee.png"), !0), Ks("tinder", "/tinder", "Tinder", t("tinder.webp")), Ks("yellowpages", "/yellowpages", "Yellow Pages", t("yellowpages.webp")), ...Object.keys(null != (e = Ao.settings.customApps) ? e : []).map((e => Ks(e, "/custom/" + e, Fs(e), t("settings.png")))), Ks("weazel", "/weazel", "Weazel News", t("weazel.webp")), Ks("casino", "/casino", "Blaze", t("blaze.webp")), Ks("calculator", "/calculator", "Calculadora", t("calculator.webp")), Ks("notes", "/notes", "Anotações", t("notes.webp")), Ks("minesweeper", "/minesweeper", "Campo Minado", t("minesweeper.webp")), Ks("truco", "/truco", "Truco", t("truco.webp"))].filter((e => null == e ? void 0 : e.enabled)).map(((e, t) => s(s({}, e), {
		bottom: t < 4
	})))
}
...
const gv = {
		setup() {
			...
			return Ao.backend.ig_vrp_users().then((async l => {
				n.value = l, t.value = await Ao.backend.ig_max_vrp_users(), e.value = !1
...
gv.render = function(e, t, n, l, a, s) {
	...
	}, null, 12, ["src"])]), Pl("ul", kv, [(wl(!0), _l(bl, null, fa(l.vrp_users, (e => {
		var t;
		return wl(), _l("li", {
	...
	})), 128))]), l.max > l.vrp_users.length ? (wl(), _l("div", {
		key: 0,
		class: ["text-center", {
			"my-auto": !l.vrp_users.length
		}]
	}, [Pl("button", {
...
MP_Footer.render = function(e, t, n, l, a, s) {
	return wl(), _l("div", MP_Footer_Class, [Pl("button", {
		onClick: t[1] || (t[1] = t => e.$router.replace("/marketplace")),
		class: {
			"text-olx": "/marketplace" == e.$route.path
		}
	}, [cS, uS], 2), Pl("button", {
		onClick: t[2] || (t[2] = t => e.$router.push("/marketplace/create")),
		class: {
			"text-olx": "/marketplace/create" == e.$route.path
		}
	}, [dS, pS], 2), Pl("button", {
		onClick: t[3] || (t[3] = t => e.$router.push("/marketplace/search")),
		class: {
			"text-olx": "/marketplace/search" == e.$route.path
		}
	}, [fS, mS], 2), Pl("button", {
		onClick: t[4] || (t[4] = t => e.$router.push("/marketplace/dashboard")),
		class: {
			"text-olx": "/marketplace/dashboard" == e.$route.path
		}
	}, [hS, bS], 2)])
};
const MP_Ad = {
	...
	setup({
		...
		return {
			...
			destroy: function() {
				n("Deseja excluir este anúncio?").then((t => {
					t && Ao.backend.marketplace_destroy(e.id).then((() => e.id = null))
				}))
			}
		}
	}
};
MP_Ad.render = function(e, t, n, l, a, s) {
	return n.data.id ? (wl(), _l("div", eS, [Pl("img", {
		src: n.data.images[0],
		class: "w-full block",
		alt: ""
		...
		onClick: t[2] || (t[2] = t => e.$router.push("/marketplace/" + n.data.id)),
		class: "bg-olx px-6 py-2 text-white rounded-xl"
	}, " Ver mais ")])])])])) : Ml("", !0)
};
const MP_Home = {
	...
	setup() {
		jl("setDark")(!0);
		const e = rt([]);
		return Ao.backend.marketplace_search("%", "%").then((t => {
			e.value = t
		})), {
			ads: e
		}
...
MP_Home.render = function(e, t, n, l, a, s) {
	const o = dl("Header"),
		r = dl("Ad"),
		i = dl("Footer");
	return wl(), _l("div", vS, [Pl(o, {
	...
	MP_Create = {
		...
		setup() {
			...
			return {
				...
				addImage: async function() {
					try {
						const e = await Ao.useAnyImage("/marketplace");
						MP_AS.value.push(e)
					} catch (e) {}
				},
				submit: function() {
					...
					for (let e in l) l[e] = l[e].value;
					return l.title.trim() ? l.category ? l.price ? l.images.length ? (l.price = parseInt(null == (n = l.price) ? void 0 : n.replace(/\D/g, "")), void Ao.backend.marketplace_createAd(l).then((n => {
						if (n.error) return t(n.error);
						e.replace("/marketplace"), MP_kS.value = "", MP_wS.value = "", MP_CS.value = void 0, MP__S.value = "", MP_AS.value = []
					}))) : t("Ao menos uma imagem é obrigatória.") : t("Insira um preço") : t("Escolha uma categoria") : t("Título inválido")
				}
			}
		}
	};
MP_Create.render = function(e, t, n, l, a, s) {
	const o = dl("Header"),
		r = dl("app-input"),
		i = dl("app-select");
	return wl(), _l("div", TS, [Pl(o, {
...
const MP_Search = {
	...
	setup() {
		...
		function a() {
			let l = e.value || "%";
			"%" != l && (l = "%" + l + "%"), Ao.backend.marketplace_search(l, t.value).then((e => n.value = e))
		}
		return Tn(e, (() => {
			clearTimeout(l), l = setTimeout(a, 500)
		})), Tn(t, (() => a())), a(), {
...
MP_Search.render = function(e, t, n, l, a, s) {
	const o = dl("Header"),
		r = dl("app-input"),
		i = dl("app-select"),
		c = dl("Ad");
...
const MP_Details = {
	...
	setup() {
		const e = tc(),
			...
			n = rt(0),
			l = Ao.identity;
		return Ao.backend.marketplace_fetch(e.params.id).then((e => {
			if (t.value = e || !1, e)
				for (let t of e.images) {
					(new Image).src = t
				}
...
MP_Details.render = function(e, t, n, l, a, s) {
	const o = dl("Header");
	return wl(), _l("div", GS, [Pl(o, {
		title: "Detalhes"
	}), l.ad ? (wl(), _l("div", WS, [Pl("div", KS, [0 != l.imgIndex ? (wl(), _l("button", {
...
const MP_Dashboard = {
	...
	setup() {
		...
		const e = jl("alert"),
			t = rt();
		return Ao.backend.marketplace_dashboard().then((e => {
			t.value = e
		})), {
			ads: t,
			destroy: function(n) {
				Ao.backend.marketplace_destroy(n).then((l => {
					(null == l ? void 0 : l.error) ? e(l.error): t.value = t.value.filter((e => e.id != n))
				}))
			}
		}
...
MP_Dashboard.render = function(e, t, n, l, a, s) {
	var o;
	const r = dl("Header");
	return wl(), _l("div", yT, [Pl(r, {
		title: "Seus anúncios"
...
const kO = [{
		...
		component: MP_Dashboard
	}, {
		path: "/marketplace/:id",
		component: MP_Details
	}, {
		path: "/tinder",
		component: LT
	}, {
