	...
	if not radioPressed and radioEnabled then
		if radioChannel > 0 then
			...
			if LoadAnim("anim@male@holding_radio") then
				...
				radioProp = CreateObject(GetHashKey("prop_cs_hand_radio"),coords.x,coords.y,coords.z,false,false,false)
				SetEntityCollision(radioProp,false,false)
				AttachEntityToEntity(radioProp,PlayerPedId(),GetPedBoneIndex(PlayerPedId(),28422),0.0750,0.0230,-0.0230,-90.0000,0.0,-59.9999,false,false,false,false,2,true)
			end
