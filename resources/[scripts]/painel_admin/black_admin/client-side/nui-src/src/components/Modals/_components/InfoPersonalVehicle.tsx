...
export const InfoPersonalVehicleModal = () => {
  ...
  return (
    <div className="flex flex-col justify-between absolute z-50 w-[1354px] h-[551px] bg-zinc-900 border-1 border-white/10 rounded-[10px] -translate-x-1/2 -translate-y-1/2 left-1/2 top-1/2">
      ...
      <button
        className="absolute right-[59px] top-[15px] h-[40px] w-[129px] rounded-[5px] uppercase border-1 border-white/5 bg-white/2 text-[12px] font-white text-white hover:bg-white/5"
        onClick={() => {
