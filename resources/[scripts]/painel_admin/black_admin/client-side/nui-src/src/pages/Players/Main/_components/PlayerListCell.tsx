...
export const PlayerListCellPopulated = ({ data }: { data: Player }) => {
  ...
  return (
    <div
      ...
      className={clsx(
        "cursor-pointer w-[757px] h-[57px] flex-none rounded-[5px] border-1 border-white/5 flex items-center relative",
    ...
    >
      ...
      <button
        onClick={(e) => {
          ...
          navigate("/players/infos", { state: data });
        }}
...
export const PlayerListCell = () => {
  return (
    <div className="w-[757px] h-[57px] flex-none rounded-[5px] border-1 border-white/5 grid place-items-center">
