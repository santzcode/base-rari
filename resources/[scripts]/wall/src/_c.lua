...
local armas = {
    ...
    [tostring(GetHashKey('WEAPON_HEAVYSNIPER'))] = 'HEAVY SNIPER', [tostring(GetHashKey('WEAPON_HEAVYSNIPER'))] = 'Heavy Sniper', [tostring(GetHashKey('WEAPON_HEAVYSNIPER'))] = 'Heavy Sniper',
