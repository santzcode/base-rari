const imgDir = "http://151.244.40.71/nation_tattoos/"; // DIRETÓRIO DAS IMAGENS
...
const componentsImages = {
    male: {
        head: imgDir.concat("male/unknown6.png"),
        torso: imgDir.concat("male/unknown12.png"),
        ['arms-section']: imgDir.concat("male/unknown4.png"),
        ['legs-section']: imgDir.concat("male/unknown3.png"),
        overlay: imgDir.concat("male/unknown2.png"),
        leftArm: imgDir.concat("male/unknown1.png"),
        rightArm: imgDir.concat("male/unknown17.png"),
        leftLeg: imgDir.concat("male/unknown5.png"),
        rightLeg: imgDir.concat("male/unknown16.png"),
    },
    female: {
        head: imgDir.concat("female/unknown10.png"),
        torso: imgDir.concat("female/unknown8.png"),
        ['arms-section']: imgDir.concat("female/unknown.png"),
        ['legs-section']: imgDir.concat("female/unknown7.png"),
        overlay: imgDir.concat("female/unknown9.png"),
        leftArm: imgDir.concat("female/unknown11.png"),
        rightArm: imgDir.concat("female/unknown13.png"),
        leftLeg: imgDir.concat("female/unknown14.png"),
        rightLeg: imgDir.concat("female/unknown15.png"),
    },
}