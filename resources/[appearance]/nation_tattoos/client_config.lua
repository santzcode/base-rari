...
local tattooShops = {
	[1] = { coords = vec3(1321.38,-1654.27,52.27), h = 351.5, perm = nil },
	[2] = { coords = vec3(-1155.75,-1427.19,4.95), h = 325.99 },
	[3] = { coords = vec3(324.86,180.35,103.59), h = 104.89 },
	[4] = { coords = vec3(-3169.43,1077.87,20.83), h = 195.6 },
	[5] = { coords = vec3(1864.57,3746.87,33.03), h = 56.7 },
	[6] = { coords = vec3(-294.67,6200.83,31.49), h = 235.28 },
}
