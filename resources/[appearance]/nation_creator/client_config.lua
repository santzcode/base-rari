...
nation_skinshop = false -- desativado temporariamente

creatorCoords = vec3(-1062.02,-2711.85,0.83)
creatorHeading = 226.2

spawnCoords = vec3(176.76,-906.14,30.68)
spawnHeading = 249.45
...
function selectCharacter(info)
    if info then
        ...
        TriggerEvent('reloadtattos',info.tattoos)
    end
