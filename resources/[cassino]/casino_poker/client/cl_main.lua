...
function setupSecondButtons(scaleform)
    ...
    for i, message in ipairs(messages) do
        ...
        Button(GetControlInstructionalButton(0, 176 + i, true))
...
function setupThirdButtons(scaleform)
    ...
    local messages = {
        { control = 38, message = _U('play_cards') },
        { control = 177, message = _U('fold_cards') } 
    }

    for i, buttonData in ipairs(messages) do
        PushScaleformMovieFunction(scaleform, 'SET_DATA_SLOT')
        PushScaleformMovieFunctionParameterInt(i)
        Button(GetControlInstructionalButton(0, buttonData.control, true))
    ...
    PushScaleformMovieFunctionParameterInt(80) -- Alpha 
    PopScaleformMovieFunctionVoid()
